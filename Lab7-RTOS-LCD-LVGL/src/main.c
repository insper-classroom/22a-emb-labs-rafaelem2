...
void lv_termostato(void) {
	...
	lv_obj_align(btnMenu, LV_ALIGN_BOTTOM_LEFT,60, -20);
	...
	lv_obj_align(btnClk, LV_ALIGN_BOTTOM_LEFT, 110, -20);
	...
	lv_obj_align(btnUp, LV_ALIGN_BOTTOM_RIGHT, -75, -20);
	...
	lv_label_set_text_fmt(labelFloor, "%02d", 19);
	
	labelSetValue = lv_label_create(lv_scr_act());
	lv_obj_align(labelSetValue, LV_ALIGN_RIGHT_MID , -15 , -20);
	lv_obj_set_style_text_font(labelSetValue, &dseg35, LV_STATE_DEFAULT);
